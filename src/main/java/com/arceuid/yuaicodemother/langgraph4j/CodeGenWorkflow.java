package com.arceuid.yuaicodemother.langgraph4j;

import com.arceuid.yuaicodemother.exception.BusinessException;
import com.arceuid.yuaicodemother.exception.ErrorCode;
import com.arceuid.yuaicodemother.langgraph4j.model.QualityResult;
import com.arceuid.yuaicodemother.langgraph4j.node.*;
...
public class CodeGenWorkflow {
    ...
    private String routeBuildOrSkip(MessagesState<String> stringMessagesState) {
        ...
        //HTML和MULTI_FILE模式直接跳过
        if (CodeGenTypeEnum.HTML.equals(generationType) || CodeGenTypeEnum.MULTI_FILE.equals(generationType)) {
            return "skip_build";
        }
        return "build";
    }
